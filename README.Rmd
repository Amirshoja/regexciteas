...
The goal of regexciteas is to make regular expressions more exciting!
...
You can install the development version of regexciteas from [GitHub](https://github.com/) with:
